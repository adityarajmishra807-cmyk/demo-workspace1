    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="rounded-2xl border border-white/10 p-6 space-y-5">
        ...
        <div className="grid sm:grid-cols-2 gap-5">
          <Field label="Business Name" error={errors.businessName} hint={errors.businessName ? undefined : undefined}>
            <input
      ...
      <div className="rounded-2xl border border-white/10 p-6 space-y-5">
        ...
        <div className="grid sm:grid-cols-2 gap-5">
          ...
          <Field label="Email">
            <input className={inputClass} value={form.email} onChange={(e) => update('email', e.target.value)} placeholder="hello@..." />
          </Field>
          <Field label="WhatsApp">
            <input className={inputClass} value={form.whatsapp} onChange={(e) => update('whatsapp', e.target.value)} placeholder="+91 ..." />
          </Field>
          <Field label="Instagram">
            <input className={inputClass} value={form.instagram} onChange={(e) => update('instagram', e.target.value)} placeholder="@handle" />
          </Field>
        </div>
      </div>
      ...
      <div className="rounded-2xl border border-white/10 p-6 space-y-5">
        ...
        <Field label="Hero Image URL" hint="A URL to the main background image">
          <input className={inputClass} value={form.heroImage} onChange={(e) => update('heroImage', e.target.value)} placeholder="https://..." />
        </Field>
      ...
      <div className="rounded-2xl border border-white/10 p-6 space-y-5">
        ...
        <Field label="CTA Text" hint="Main call-to-action button text">
      ...
      <div className="flex items-center justify-end gap-4 pt-2">
        <button
          type="button"
          onClick={onCancel}
          className="px-6 py-3 rounded-xl text-sm font-medium text-white/60 hover:text-white transition-colors"
        >
          Cancel
        </button>
        <button

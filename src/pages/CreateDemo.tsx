          ...
          <div className="max-w-lg mx-auto text-center py-16">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6 mb-8">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  onClick={handleCopy}
                  className="shrink-0 inline-flex items-center gap-1.5 px-3 py-2 rounded-lg bg-white/10 hover:bg-white/15 text-sm font-medium transition-colors"
                >
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              <button
                onClick={() => navigate('/dashboard')}
                className="px-6 py-3 rounded-xl border border-white/15 hover:border-white/30 hover:bg-white/5 text-white font-semibold text-sm transition-all duration-300"
              >
                Back to Dashboard
              </button>
            </div>
